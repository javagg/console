...
define([
    ...
    'util/settings',
    'ace',
    'text!views/settings/console/templates/style-settings.ejs'],
    function ($, Backbone, _, Polyglot, Logger, Settings, Ace, StyleSettingsTemplate) {
        ...
        return Backbone.View.extend({
            ...
            logger: new Logger('Style Settings'),
            ...
            render: function () {
                ...
                var that = this,
                    template = _.template(StyleSettingsTemplate, { });
                ...
                var custom_style = Settings.getSetting('style');
                if (custom_style) {
                    this.editor.setValue(custom_style);
                }
            ...
            loadDefaultClicked: function () {
                this.editor.setValue(Settings.defaults.style);
                this.editor.session.selection.clearSelection();
                this.inputChanged();
            },
