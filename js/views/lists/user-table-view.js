...
define([
    ...
    'text!views/lists/templates/user-table-view-resource.ejs',
    'text!views/lists/templates/user-table-view-page-container.ejs'],
    function ($, Backbone, _, Utils, TableView, TableResourceTemplate, TablePageContainerTemplate) {
        ...
        return TableView.extend({
            ...
            makeResourceEl: function (resource) {
                return _.template(TableResourceTemplate, {resource: resource, current_user_guid: sconsole.user.info.metadata.guid});
            },
