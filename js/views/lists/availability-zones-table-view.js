...
define([
    ...
    'text!views/lists/templates/availability-zones-table-view-resource.ejs',
    'text!views/lists/templates/availability-zones-table-view-page-container.ejs'],
        ...
        return TableView.extend({
            ...
            initialize: function () {
                ...
                if (!this.options.collection) {
                    this.options.collection = sconsole.cf_api.availability_zones;
                }
            ...
            resourceRendered: function (resource, resource_el) {
                // truncate the list if there are more than 3 DEAs in the availability zone
